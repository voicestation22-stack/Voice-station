        ...
        switch (logMessageType) {
            case "log:thread-admins": {
                if (logMessageData.ADMIN_EVENT == "add_admin") {
                    ...
                    if (global.configModule[this.config.name].sendNoti) api.sendMessage(`»» NOTICE «« Update user ${logMessageData.TARGET_ID} এই নে বলদ তোরে বিশ্বাস গ্রুপে এডমিন দিলাম 😁 বিশ্বাসের মর্যদা দিস 🫵🏾`, threadID, async (error, info) => {
